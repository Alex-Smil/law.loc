...
/* вместо get_template_directory() можно использовать константу __DIR__*/
...
function law_scripts() {
	...
	*/
    ...
    /* скрипт respond.min.js подключается по условию*/
    ...
    * Подключаем именно в header так как эту библ. будет использ. слайдер из unyson
    */
    ...
    wp_enqueue_script(
        'law-jquery-easing-js',
        get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', array(), '', true
     );
    wp_enqueue_script(
        'law-bootstrap-js',
        get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), '', true
    );
    wp_enqueue_script(
        'law-jquery-waypoints-js',
        get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array(), '', true
    );
    wp_enqueue_script( //этот автор пропустил - потом исправил, так как заглючил слайдер
        'law-jquery-stellar-js',
        get_template_directory_uri() . '/assets/js/jquery.stellar.min.js', array(), '', true
    );
    wp_enqueue_script(
        'law-owl-carousel-js',
        get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), '', true
    );
    wp_enqueue_script(
        'law-jquery-flexslider-js',
        get_template_directory_uri() . '/assets/js/jquery.flexslider-min.js', array(), '', true
    );
    wp_enqueue_script(
        'law-jquery-countTo-js',
        get_template_directory_uri() . '/assets/js/jquery.countTo.js', array(), '', true
    );
    wp_enqueue_script(
        'law-jquery-magnific-popup-js',
        get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js', array(), '', true
    );
    wp_enqueue_script(
        'law-magnific-popup-options-js',
        get_template_directory_uri() . '/assets/js/magnific-popup-options.js', array(), '', true
    );
    wp_enqueue_script(
        'law-main',
